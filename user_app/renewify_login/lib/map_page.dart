...
class MapPage extends StatelessWidget {
  ...
  final LatLng initialPosition = LatLng(13.047436, 80.0953108);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Installation Center'),
        actions: [
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5.0),
                  Text(
                    '87, Pudhu St, MG Nagar, Poonamallee, Chennai, Tamil Nadu 600056',
                    style: TextStyle(
                      fontSize: 16.0,
